<%@ Page Title="About KSU Templates" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="KSU_Templates.About" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="page-section portfolio" id="portfolio">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary">King Saud University Templates</h2>
        <!-- Icon Divider-->
        <div class="divider-custom">
         ...
         <!-- About-->     
        <div class="container d-flex align-items-center flex-column" style="font-size: medium; font-family: 'Open Sans', sans-serif;">
            <p>
